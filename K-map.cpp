...
int main() {
    // Test case 1: Simple 2-variable K-map
    cout << "=== Test Case 1 ===" << endl;
    int numVar1 = 4;
    vector<int> minterms1 = {0,4,5,6,11,13,12,15};
    vector<int> dontcares1 = {};
    
    KmapSolution* sol1 = solveKmap(numVar1, minterms1, dontcares1);
    printKmapSolution(sol1);
    ...
    // Test case 2: 2-variable K-map with don't cares
    cout << "=== Test Case 2 ===" << endl;
    int numVar2 = 4;
    vector<int> minterms2 = {1,0,6,3,14,8};
    vector<int> dontcares2 = {9,15,10};
    
    KmapSolution* sol2 = solveKmap(numVar2, minterms2, dontcares2);
    printKmapSolution(sol2);
    ...
    // Test case 3: All minterms (constant 1)
    cout << "=== Test Case 3 ===" << endl;
    int numVar3 = 3;
    vector<int> minterms3 = {};
    vector<int> dontcares3 = {};
    
    KmapSolution* sol3 = solveKmap(numVar3, minterms3, dontcares3);
    printKmapSolution(sol3);
